...
const Homepage = () => {
  return (
    <div className="overflow-x-hidden w-full min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <div className="flex flex-col md:flex-row items-center justify-between px-10 py-20 bg-gray-100 w-full flex-1">
        ...
        <img src={HeroImage} alt="Hero" className="w-96 mt-10 md:mt-0" />
      </div>
