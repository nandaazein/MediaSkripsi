...
const MengenalAnalisisData = () => {
  return (
    <Layout>
      {/* Header judul */}
      <h1 className="text-xl md:text-2xl sm:text-lg text-center font-bold mb-4 p-3 sm:p-4 bg-[#255F38] text-white rounded-lg shadow-lg">
        Mengenal Analisis Data
      </h1>

      {/* Tujuan Pembelajaran */}
      <section className="bg-green-100 p-3 sm:p-4 rounded shadow-md mb-6">
        <h2 className="font-bold text-[#255F38]">Tujuan Pembelajaran:</h2>
      ...
      {/* Konten */}
      <article className="bg-white p-3 sm:p-4 rounded shadow-md text-gray-700 leading-relaxed space-y-5">
        ...
        <ul className="list-disc ml-8 space-y-2">
          <li className="text-base leading-relaxed">Membantu pengambilan keputusan yang lebih baik</li>
          <li className="text-base leading-relaxed">Menemukan pola dan tren dalam data</li>
          <li className="text-base leading-relaxed">Menyelesaikan masalah dengan efektif</li>
        </ul>
      ...
      {/* Tombol Navigasi */}
      <div className="flex justify-between mt-8 px-3 sm:px-4">
        <a
          href="/pendahuluan"
          className="bg-gray-500 text-white px-5 py-2 rounded-lg hover:bg-gray-600"
          aria-label="Halaman sebelumnya"
