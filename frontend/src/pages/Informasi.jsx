...
//       <div className="container mx-auto px-4 py-8 pt-10">
//         <h1 className="text-3xl font-bold text-[#214C1E] mb-6 text-center md:text-left">
//           Informasi Media
//         </h1>
...
//             Media pembelajaran ini dibuat untuk memenuhi persyaratan dalam menyelesaikan program Strata-1 Pendidikan Komputer dengan judul:
//           </p>
//           <p className="text-center font-bold text-gray-700 mb-10 sm:text-left">
...
//             <li></li>
//             <li></li>
//             {/* <li>Ilustrasi media pembelajaran didapatkan dari <a href="https://storyset.com/work" className="text-blue-600 hover:underline">storyset.com/work</a></li> */}
//           </ul>
//         </div>
//       </div>
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 pt-10">
        ...
        <div className="bg-white shadow-md rounded-lg p-5 border border-gray-200 mt-5">
          <div className="flex items-center mb-4">
            <i className="ri-book-2-line text-2xl text-[#1D6F35] mr-2"></i>
