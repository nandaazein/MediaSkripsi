...
//   // Handler untuk update nilai input
//   const handleInputChange = (month, value) => {
//     setExamScores((prevScores) => ({
//       ...prevScores,
//       [month]: value ? parseInt(value) : 0,
//     }));
//   };

//   // Ambil Chart.js dari window (CDN)
//   const { Chart } = window;
...
//     const data = Object.values(examScores);
...
//           {/* Input untuk Nilai Ujian */}
//           <div className="mt-6">
//             <h3 className="font-semibold text-[#255F38] flex items-center">
//               <CheckCircle className="w-5 h-5 mr-2" /> Masukkan Nilai Ujian Bulanan
//             </h3>
//             <p className="text-gray-700 mt-2">Masukkan nilai ujian untuk setiap bulan (0-100):</p>
//             <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
//               {Object.keys(examScores).map((month) => (
//                 <div key={month}>
...
//           <div className="mt-6">
//             <h3 className="font-semibold text-[#255F38] flex items-center">
//               <CheckCircle className="w-5 h-5 mr-2" /> Grafik Nilai Ujian
//             </h3>
//             <p className="text-gray-700 mt-2">Berikut adalah grafik berdasarkan nilai yang dimasukkan:</p>
//             <div className="flex flex-col md:flex-row justify-center gap-8 mt-4">
//               {/* Bar Chart */}
//               <div className="w-full md:w-1/3">
//                 <h4 className="text-center font-semibold text-gray-700">Diagram Batang</h4>
//                 <canvas ref={barChartRef}></canvas>
//               </div>
//               {/* Pie Chart */}
//               <div className="w-full md:w-1/3">
//                 <h4 className="text-center font-semibold text-gray-700">Diagram Lingkaran</h4>
//                 <canvas ref={pieChartRef}></canvas>
//               </div>
//               {/* Line Chart */}
//               <div className="w-full md:w-1/3">
//                 <h4 className="text-center font-semibold text-gray-700">Diagram Garis</h4>
