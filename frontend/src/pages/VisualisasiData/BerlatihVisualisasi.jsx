    ...
    <Layout>
      ...
      {[
        ...
        <section key={key} className="p-6 mt-6 bg-white rounded shadow-lg">
          ...
          <button
            className="px-4 py-1 mt-2 ml-2 text-white bg-red-500 rounded hover:bg-red-600 cursor-pointer"
            onClick={() => clearAnswer(key)}
          >
            Hapus
          </button>
      ...
      <div className="flex justify-between px-4 mt-10">
        <button
          onClick={() => (window.location.href = "/aktivitas-visualisasi")}
          className="px-5 py-2 text-white bg-gray-500 rounded-lg hover:bg-gray-600 cursor-pointer transition duration-300"
        >
          ← Sebelumnya
        </button>
        <button
          onClick={() => (window.location.href = "/petunjuk-kuis-visualisasi")}
          className="px-5 py-2 text-white bg-[#255F38] rounded-lg hover:bg-[#1E4D2E] cursor-pointer transition duration-300"
        >
          Mulai Kuis →
        </button>
      </div>
