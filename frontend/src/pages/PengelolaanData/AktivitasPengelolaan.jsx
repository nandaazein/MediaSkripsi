    ...
    <Layout>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10">
        <p className="text-gray-700 text-sm md:text-base flex items-center">
          ...
          Seret dan jatuhkan langkah-langkah berikut ke dalam urutan yang benar
          untuk mengurutkan nilai siswa dari yang tertinggi ke yang terendah:
        </p>
        <div className="mb-2">{renderDraggableItems(bank)}</div>
        <div
          className="border border-gray-400 p-4 rounded mb-2 min-h-[100px] bg-gray-50"
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10">
        <p className="text-gray-700 text-sm md:text-base flex items-center">
          ...
          Pilih semua pertanyaan yang benar tentang filtering:
        </p>
      ...
      <div className="flex justify-between mt-10 px-4">
        ...
        <a
          ...
          className={`px-5 py-2 rounded-lg text-white transition duration-300 shadow-md ${
            urutan.length === langkahSorting.length &&
            feedback2.startsWith("✅") &&
            feedback3.startsWith("✅") &&
            feedback4.startsWith("✅") &&
