...
const ContohPengelolaan = () => {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col items-center mt-6">
        <p className="text-gray-600 text-sm text-center mb-2 italic">
          Tabel 1. Data Hasil Lomba Pidato
        </p>
        <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
          <thead>
            <tr className="bg-[#255F38] text-white">
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="text-gray-700 list-disc pl-6 ml-6 space-y-1 mt-6">
          ...
          <li>Misalnya, urutkan data berdasarkan kolom Skor agar siswa dengan skor tertinggi muncul di atas.</li>
        </ul>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="list-disc list-inside text-gray-600 text-sm md:text-base mt-4 space-y-2">
          <li
            ...
            style={{ textIndent: "-1.5em", paddingLeft: "1.5em" }}
          >
            Setelah sorting (Z ke A), Rani (92), Siti (85), dan Adi (78) adalah tiga siswa dengan skor tertinggi.
          </li>
          <li
            className="text-justify"
            style={{ textIndent: "-1.5em", paddingLeft: "1.5em" }}
      ...
      <div className="flex flex-col items-center mt-6">
        <p className="text-gray-600 text-sm text-center mb-2 italic">
          Tabel 2. Data Kegiatan Ekstrakurikuler
        </p>
        <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
          <thead>
            <tr className="bg-[#255F38] text-white">
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="list-disc list-inside text-gray-600 text-sm md:text-base mt-4 space-y-2">
          <li
            ...
            style={{ textIndent: "-1.5em", paddingLeft: "1.5em" }}
          >
            Setelah filtering, hanya Bima dan Tono yang ditampilkan sebagai anggota tim Basket.
          </li>
          <li
            className="text-justify"
            style={{ textIndent: "-1.5em", paddingLeft: "1.5em" }}
