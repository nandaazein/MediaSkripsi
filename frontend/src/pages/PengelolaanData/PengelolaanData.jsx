...
//           Simulasi ini bertujuan membantu memahami cara mengurutkan data siswa berdasarkan nilai ujian. Pilih opsi pengurutan untuk melihat perubahan urutan data, lalu klik "Reset" untuk kembali ke data awal.
//         </p>
...
//         </h3>
//         <p className="text-gray-700 mb-4 text-justify">
//           Simulasi ini bertujuan memahami cara menyaring data siswa berdasarkan kelas. Pilih kelas untuk melihat data yang sesuai, lalu klik "Reset" untuk kembali ke data awal.
//         </p>
//         <div className="flex justify-between mb-4 items-center">
//           <div>
...
//       {/* Paragraf Setelah Simulasi */}
//       <p className="text-gray-700 text-sm md:text-base text-justify leading-relaxed px-4 mt-6">
//         Setelah melihat cara kerja sorting dan filtering, kamu kini paham bahwa sorting membantu mengurutkan data untuk analisis cepat, sedangkan filtering memungkinkan penyaringan data spesifik sesuai kriteria tertentu.
//       </p>
//       {/* Dekomposisi */}
...
export default function PengelolaanData() {
  ...
  return (
    <Layout>
      ...
      {/* Paragraf Setelah Simulasi */}
      <p className="text-gray-700 text-sm md:text-base text-justify leading-relaxed px-4 mt-6">
        Setelah melihat cara kerja sorting dan filtering, kamu paham bahwa sorting mengurutkan data untuk analisis cepat, sedangkan filtering menyaring data spesifik.
      </p>
      {/* Dekomposisi */}
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
        <div className="absolute -top-6 left-4 bg-green-800 text-white px-5 py-2 rounded-t-lg text-lg font-bold flex items-center shadow-lg">
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
        ...
        <p className="text-gray-700 text-sm md:text-base mt-6 text-justify">
          Setelah menentukan cara mengelola data, kenali pola dalam data.
        </p>
        <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
          <li className="text-justify">
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <p className="text-gray-700 text-sm md:text-base mt-4 text-justify">
          Fokus pada data penting untuk memudahkan penggunaan.
        </p>
        <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
          <li className="text-justify">
            <strong>Abaikan info tidak perlu</strong> → Hanya lihat kolom Kelas untuk siswa 8A.
          </li>
          <li className="text-justify">
            <strong>Saring data relevan</strong> → Tampilkan hanya siswa kelas 8A.
          </li>
        </ul>
        {/* Latihan Pemahaman: Abstraksi */}
        <div className="bg-[#F0FFF4] p-4 border border-[#81C784] rounded mt-4 shadow-md">
          ...
          <p className="text-gray-700 text-base text-justify mb-2">
            Kamu ingin menyaring siswa dari kelas 8A dari tabel nama, kelas, nilai, dan alamat. Pilih data yang diperlukan:
          </p>
          <p className="text-gray-600 text-sm italic mb-2">
            (✅ Kamu bisa memilih lebih dari satu jawaban.)
          </p>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <p className="text-gray-600 text-sm md:text-base mt-4 text-justify">
          Kita bisa membuat langkah sistematis untuk sorting dan filtering di spreadsheet.
        </p>
        <p className="text-gray-700 text-sm md:text-base mt-4">
          📌 Sorting – Urutkan Nilai dari Tinggi ke Rendah:
        </p>
        <div className="flex flex-col items-center mt-4">
          <p className="text-gray-600 text-sm text-center mb-2 italic">
            Tabel 5. Data Awal untuk Sorting
          </p>
          <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
            <thead>
              <tr className="bg-[#255F38] text-white">
        ...
        <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
          ...
          <li>Klik kanan, lalu pilih <em>Sort</em>.</li>
          <li>Pilih <strong>Sort Z to A</strong> untuk urutkan dari besar ke kecil.</li>
          <li>Urutkan berdasarkan kolom Nilai Tugas.</li>
        </ul>
        <p className="text-gray-700 text-sm md:text-base mt-4">
          Setelah sorting, data menjadi:
        </p>
        <div className="flex flex-col items-center mt-4">
          <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
            <thead>
        ...
        <p className="text-gray-700 text-sm md:text-base mt-4">
          📌 Filtering – Tampilkan Siswa Kelas 8A:
        </p>
        <div className="flex flex-col items-center mt-4">
          <p className="text-gray-600 text-sm text-center mb-2 italic">
            Tabel 6. Data Awal untuk Filtering
          </p>
          <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
            <thead>
              <tr className="bg-[#255F38] text-white">
        ...
        <ul className="list-disc list-inside ml-6 text-gray-700 space-y-2">
          <li>Blok semua data, termasuk header.</li>
          <li>Klik kanan pada kolom "Kelas", pilih <em>Filter</em>.</li>
          <li>Centang hanya <strong>"8A"</strong>.</li>
          <li>Untuk tampilkan semua kelas, centang <strong>"Select All"</strong>.</li>
        </ul>
        <p className="text-gray-700 text-sm md:text-base mt-4">
          Setelah filtering, data menjadi:
        </p>
        <div className="flex flex-col items-center mt-4">
          <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
            <thead>
