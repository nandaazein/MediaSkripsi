...
//       navigate("/feedback4", { state: { answers, correctCount, score, correctAnswers, answerOptions } });
//     } catch (error) {
...
const QuizPengelolaanData = () => {
  ...
  const correctAnswers = {
    ...
    q5: "b", // Filtering
    q6: "b", // Sort Z-A
    q7: "d", // Abstraksi (diubah ke pengenalan pola)
    q8: "c", // Sort A-Z (diubah dari filtering ke sorting)
    q9: "a", // Pengenalan pola (diubah ke membantu menambah data)
    q10: "d", // Sorting descending (diubah dari filtering ke sorting)
  };
  ...
  const answerOptions = {
    ...
    q9: {
      a: "Membantu menambah data baru dengan pola yang sama",
      b: "Memudahkan pemahaman urutan atau struktur data",
      c: "Mengubah data menjadi format lain",
      d: "Menghapus data yang tidak diperlukan",
    },
  ...
  return (
    <Layout>
      ...
      {/* Soal 8: Sorting Ekstrakurikuler */}
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        <div className="absolute -top-6 left-4 bg-green-800 text-white px-5 py-2 rounded-t-lg text-lg font-bold shadow-lg">
          Soal 8
        </div>
        ...
        <p className="text-gray-700 text-sm md:text-base mt-4">
          Dalam studi kasus ekstrakurikuler, jika Sari ingin mengurutkan siswa berdasarkan nama secara alfabetis (A-Z), langkah yang tepat adalah...
        </p>
        <ul className="list-none space-y-2">
          {Object.entries(answerOptions.q8).map(([key, value]) => (
            <li key={key}>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <p className="text-gray-700 text-sm md:text-base mt-6">
          Apa manfaat utama dari pengenalan pola dalam pengelolaan data?
        </p>
        <ul className="list-none space-y-2">
          {Object.entries(answerOptions.q9).map(([key, value]) => (
            <li key={key}>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <p className="text-gray-700 text-sm md:text-base mt-4">
          Jika kamu memiliki data penjualan dan ingin mengurutkan produk berdasarkan harga dari tertinggi ke terendah, teknik yang digunakan adalah...
        </p>
        <ul className="list-none space-y-2">
          {Object.entries(answerOptions.q10).map(([key, value]) => (
            <li key={key}>
