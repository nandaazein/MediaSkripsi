...
export default function PetunjukQuizPengelolaan() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full text-center">
        {/* Judul Kuis */}
        <h1 className="text-3xl font-bold text-green-800">KUIS 4</h1>
        <p className="text-lg text-gray-600 mt-1">Pengelolaan Data</p>
