...
// import autoTable from "jspdf-autotable"; // Impor eksplisit untuk jspdf-autotable
...
//     if (!user || user.role !== "teacher") {
//       console.log("Mengalihkan ke /masuk karena pengguna atau peran tidak valid");
//       window.location.href = "/masuk";
//     } else {
//       fetchScores();
//       fetchClasses();
...
//           : null,
//       };
//       console.log("Memperbarui nilai untuk NIS:", selectedScore.nis, updatedData);
...
//   const exportToPDF = () => {
//     const doc = new jsPDF();
//     doc.autoTable = autoTable; // Terapkan plugin autoTable secara eksplisit
      ...
      <section className="bg-gray-100 p-4 sm:p-6 rounded shadow-md mt-6 mb-6 text-center">
        ...
        <div className="flex justify-between mb-6 items-center">
          ...
          <div className="space-x-2">
            <button
              onClick={exportToPDF}
              className="px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-200 text-sm cursor-pointer"
            >
              Ekspor PDF
            </button>
            <button
