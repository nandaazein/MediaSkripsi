          ...
          <table className="w-full border-collapse text-gray-700">
            <thead className="bg-[#255F38] text-white">
              <tr>
                ...
                <th className="p-2 border-b-2 border-gray-300 text-center text-sm">Latihan 1</th>
            ...
            <tbody>
              {filteredScores.map((score) => (
                ...
                >
                  ...
                  <td className="p-2 border-b border-gray-200 text-sm">{score.latihan4 ?? '-'}</td>
                  <td className="p-2 border-b border-gray-200 text-sm">{score.kuis1 ?? '-'}</td>
                  <td className="p-2 border-b border-gray-200 text-sm">{score.kuis2 ?? '-'}</td>
                  <td className="p-2 border-b border-gray-200 text-sm">{score.kuis3 ?? '-'}</td>
                  <td className="p-2 border-b border-gray-200 text-sm">{score.kuis4 ?? '-'}</td>
                  <td className="p-2 border-b border-gray-200 text-sm">{score.evaluasi_akhir ?? '-'}</td>
                    ...
                    <button
                      onClick={() => {
                        ...
                        setFormData({
                          ...
                          evaluasi_akhir: score.evaluasi_akhir?.toString() || ''
                        });
                        setIsModalOpen(true);
                      }}
      ...
      {isModalOpen && selectedScore && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-lg">
            <h3 className="text-base font-medium text-[#255F38] mb-4">Edit Nilai Siswa</h3>
            <div className="grid grid-cols-2 gap-3">
              <input
                type="number"
                value={formData.latihan1}
                onChange={(e) => setFormData({ ...formData, latihan1: e.target.value })}
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, latihan2: e.target.value })}
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, latihan3: e.target.value })}
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, latihan4: e.target.value })}
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, kuis1: e.target.value })}
                placeholder="Kuis 1"
                className="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#255F38] transition text-sm"
              />
              <input
                ...
                onChange={(e) => setFormData({ ...formData, kuis2: e.target.value })}
                placeholder="Kuis 2"
                className="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#255F38] transition text-sm"
              />
              <input
                ...
                onChange={(e) => setFormData({ ...formData, kuis3: e.target.value })}
                placeholder="Kuis 3"
                className="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#255F38] transition text-sm"
              />
              <input
                ...
                onChange={(e) => setFormData({ ...formData, kuis4: e.target.value })}
                placeholder="Kuis 4"
                className="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#255F38] transition text-sm"
              />
              <input
                ...
                onChange={(e) => setFormData({ ...formData, evaluasi_akhir: e.target.value })}
