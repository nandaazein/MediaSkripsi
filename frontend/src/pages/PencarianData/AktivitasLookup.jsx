...
// //             Silakan seret dan jatuhkan formula HLOOKUP yang tepat di sini:
// //           </p>
// //           <iframe
// //             width="100%"
// //             height="400"
...
// //                 className="p-2 bg-green-100 border border-green-500 rounded-lg hover:bg-green-200 text-center cursor-pointer transition-transform transform hover:scale-105"
// //               >
// //                 {f}
// //               </div>
// //             ))}
...
// //             </button>
// //             <button
// //               onClick={() => clearInputsAndFeedback(setSelectedFormula, setFormulaFeedback, setIsFormulaCorrect)}
...
// //                   <td className="border p-2">Tentukan tabel referensi (<b>table array</b>).</td>
// //                 </tr>
// //                 <tr>
// //                   <td className="border p-2 text-center">2</td>
// //                   <td className="border p-2">Tentukan tipe pencarian: tepat (<b>FALSE</b>) atau mendekati (<b>TRUE</b>).</td>
// //                 </tr>
// //                 <tr>
...
// //                   <td className="border p-2">Tentukan nilai yang ingin dicari (<b>lookup value</b>).</td>
// //                 </tr>
// //               </tbody>
// //             </table>
// //           </div>
...
// //             </button>
// //             <button
// //               onClick={() => clearInputsAndFeedback(setStepOrder, setStepFeedback, setIsOrderCorrect)}
// //               className="ml-2 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-200"
// //             >
// //               Hapus
// //             </button>
...
// //             Gunakan fungsi <b> INDEX</b> untuk menampilkan nilai dari baris ke-2 dan kolom ke-3 dari tabel berikut:
// //           </p>
...
// //           Gunakan fungsi <b>MATCH</b> untuk menemukan posisi nilai 92 pada kolom Matematika berikut:
// //         </p>
...
// //             Gunakan fungsi <b>CHOOSE</b> untuk memilih siswa ke-2 dari daftar berikut: Ali, Siti, Budi.
// //           </p>
// //           <div className="flex items-center px-4 mb-2">
// //             <input
// //               type="text"
...
// //               semuaBenar ? "bg-[#255F38] hover:bg-green-700" : "bg-gray-400 cursor-not-allowed"
// //             }`}
// //           >
// //             Selanjutnya →
// //           </button>
