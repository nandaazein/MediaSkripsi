...
//   const checkIndex = () => {
//     const trimmed = indexFormula.trim();
//     const isCorrect = trimmed === correctIndex;
//     setIsIndexCorrect(isCorrect);
//   };

//   const checkMatch = () => {
//     const trimmed = matchFormula.trim();
//     const isCorrect = trimmed === correctMatch;
//     setIsMatchCorrect(isCorrect);
//   };

//   const checkChoose = () => {
//     const trimmed = chooseFormula.trim();
//     const isCorrect = trimmed === correctChoose;
...
//           Aktivitas Peringkasan
//         </h1>

//         {/* Soal 1 */}
//         <p class Name="px-4 mb-2 text-gray-700 font-medium">1. Drop formula HLOOKUP yang tepat:</p>
//         <iframe
...
//         {/* Soal 3 */}
//         <p className="px-4 mt-8 text-gray-700 font-medium">
//           3. Gunakan fungsi <b>INDEX</b> untuk menampilkan nilai baris ke-2 kolom ke-3 dari tabel:
//         </p>
...
//             </tr></thead>
//             <tbody>
//               <tr><td className="border p-2">Ali</td><td className="border p-2">90</td><td className="border p-2">88</td></tr>
//               <tr><td className="border p-2">Siti</td><td className="border p-2">92</td><td className="border p-2">{isIndexCorrect ? "85" : ""}</td></tr>
//             </tbody>
//           </table>
//         </div>
...
//             Periksa
//           </button>
//           <button onClick={() => clearInputsAndFeedback(setIndexFormula, null, setIsIndexCorrect)} className="ml-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700">
//             Hapus
//           </button>
//         </div>
//         {isIndexCorrect !== null && (
...
//         {/* Soal 4 */}
//         <p className="px-4 mt-8 text-gray-700 font-medium">
//           4. Gunakan fungsi <b>MATCH</b> untuk menemukan posisi nilai 92 pada kolom Matematika:
//         </p>
//         <div className="overflow-x-auto px-4 mt-2 mb-4">
//           <table className="w-full border text-sm border-gray-400 text-gray-800">
//             <thead><tr className="bg-green-200"><th className="border p-2">Nama</th><th className="border p-2">Matematika</th></tr></thead>
//             <tbody>
//               <tr><td className="border p-2">Ali</td><td className="border p-2">90</td></tr>
//               <tr><td className="border p-2">Siti</td><td className="border p-2">{isMatchCorrect ? "92 ✅ Posisi: 2" : "92"}</td></tr>
//             </tbody>
//           </table>
//         </div>
//         <div className="flex items-center px-4 mb-2">
...
//             Periksa
//           </button>
//           <button onClick={() => clearInputsAndFeedback(setMatchFormula, null, setIsMatchCorrect)} className="ml-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700">
//             Hapus
//           </button>
//         </div>
//         {isMatchCorrect !== null && (
...
//         {/* Soal 5 */}
//         <p className="px-4 mt-8 text-gray-700 font-medium">
//           5. Gunakan fungsi <b>CHOOSE</b> untuk memilih siswa ke-2 dari daftar: Ali, Siti, Budi.
//         </p>
//         <div className="flex items-center px-4 mb-2">
...
//             Periksa
//           </button>
//           <button onClick={() => clearInputsAndFeedback(setChooseFormula, null, setIsChooseCorrect)} className="ml-2 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-700">
//             Hapus
//           </button>
//         </div>
...
//           <button
//             disabled={!semuaBenar}
//             onClick={() => window.location.href = "/kuis-ringkasan"}
