...
const KuisPencarianData = () => {
  ...
  // Ambil data soal dari backend (hanya quiz_number: 1)
  useEffect(() => {
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      console.log('Navigating to /feedback1 with state:', { score, answers, questions, totalQuestions: questions.length });
      navigate('/feedback1', {
        state: {
          score,
          answers,
      ...
      console.log('Navigation to /feedback1 completed');
    }
  };
  ...
  return (
    <LayoutSiswa>
      <div className="p-6">
        <h2 className="text-xl font-bold text-green-800 mb-4">AnalyticsLearn - Kuis 1</h2>
