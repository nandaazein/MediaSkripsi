...
//             {dekomposisiSteps[1] && (
//               <p className="text-gray-700 pl-4 bg-gray-100 p-3 rounded">
//                 <strong>Data:</strong> Gunakan tabel absen dengan nomor (1, 2, 3) dan nama (Siti, Rudi, Tina).
//               </p>
//             )}
//             <button
...
//             </h3>
//             <p className="text-gray-700 mt-2">
//               Budi ingin tahu posisi timnya di lomba cerdas cermat. Daftar tim berisi: kode "T01" (Tim A), "T02" (Tim B), "T03" (Tim C). Budi ingin mencari posisi kode "T02".
//             </p>
//             <p className="text-gray-700 mt-4">
//               Klik tombol berikut untuk melihat langkah-langkah pencarian:
//             </p>
...
//             </h3>
//             <p className="text-gray-700 mt-2">
//               Siti ingin tahu hadiah untuk peringkat 2 di lomba sekolah. Daftar hadiah: peringkat 1 (Tas), peringkat 2 (Buku), peringkat 3 (Pensil). Siti ingin mencari hadiah untuk peringkat 2.
//             </p>
//             <p className="text-gray-700 mt-4">
//               Klik tombol berikut untuk melihat langkah-langkah pencarian:
//             </p>
...
//                 <p className="text-gray-700 pl-4 bg-gray-100 p-3 rounded">
//                   <strong>Daftar:</strong> Tulis hadiah (1-Tas, 2-Buku, 3-Pensil).
//                 </p>
//               )}
//               <button
