...
//               =VLOOKUP(C3;$F$2:$G$6;<span className="font-semibold">2</span>;FALSE)
//             </code>
...
const ContohLookup = () => {
  return (
    <Layout>
      ...
      <div className="flex flex-col items-center mt-2">
        <p className="text-gray-600 text-sm text-center mb-2 italic">Tabel 1. Daftar Siswa</p>
        <table className="border-collapse border border-green-800 w-full md:w-2/3 text-center">
          <thead>
            <tr className="bg-[#255F38] text-white">
              <th className="border border-green-600 px-4 py-2">No</th>
        ...
        <p className="text-gray-600 text-sm text-center mb-2 italic mt-4">Tabel 2. Daftar Nilai Ujian</p>
        <table className="border-collapse border border-green-800 w-full md:w-1/3 text-center">
          <thead>
            <tr className="bg-[#255F38] text-white">
              <th className="border border-green-600 px-4 py-2">NIS</th>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-12 relative">
        ...
        <ul className="text-gray-700 list-disc pl-6 ml-6 space-y-1 mt-6">
          ...
          <li>Ada dua tabel: <span className="font-semibold">Tabel 1</span> berisi daftar siswa dan NIS mereka, sedangkan <span className="font-semibold">Tabel 2</span> berisi daftar NIS dan nilai ujian.</li>
          <li>Kita perlu mencocokkan NIS di Tabel 1 dengan daftar di Tabel 2 untuk mendapatkan nilai ujian yang benar.</li>
        </ul>
      </div>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="text-gray-700 list-disc pl-6 ml-6 space-y-1 mt-6">
          <li>Setiap NIS di <span className="font-semibold">Tabel 1</span> bisa dicocokkan dengan nilai ujian yang tersedia di <span className="font-semibold">Tabel 2</span>.</li>
          <li>Misalnya, jika NIS adalah <span className="font-semibold">1002</span>, maka nilai ujiannya adalah <span className="font-semibold">78</span>, karena di <span className="font-semibold">Tabel 2</span>, NIS <span className="font-semibold">1002</span> punya nilai <span className="font-semibold">78</span>.</li>
          <li>Polanya adalah mencari NIS dalam daftar dan mengambil nilai ujian yang sesuai.</li>
          <li><span className="font-semibold">Tabel 2 tidak diurutkan</span>, sehingga kita harus menggunakan pencarian persis dengan parameter <span className="font-semibold">FALSE</span> untuk memastikan NIS cocok.</li>
        </ul>
      </div>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="text-gray-700 list-disc pl-6 ml-6 space-y-1 mt-6">
          ...
          <li>Fokus hanya pada dua kolom penting: <span className="font-semibold">NIS</span> di <span className="font-semibold">Tabel 1</span> dan <span className="font-semibold">Nilai Ujian</span> di <span className="font-semibold">Tabel 2</span>.</li>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        <ul className="text-gray-700 list-disc pl-6 ml-6 space-y-1 mt-6">
          <li>
            <span className="font-semibold">Pilih sel tempat memasukkan rumus</span>
            <br />
            Klik sel <span className="font-semibold">D3</span> di kolom <span className="font-semibold">Nilai Ujian</span> pada <span className="font-semibold">Tabel 1</span>.
          </li>
          <li>
            <span className="font-semibold">Masukkan rumus VLOOKUP</span>
            <br />
            <code className="bg-gray-200 px-2 py-1 rounded">
              =VLOOKUP(C3;$F$2:$G$8;<span className="font-semibold">2</span>;FALSE)
            </code>
            <ul className="list-disc pl-6 ml-6 space-y-1 mt-2">
              <li>
                <span className="font-semibold">C3</span> → NIS yang akan dicari.
              </li>
              <li>
                <span className="font-semibold">$F$2:$G$8</span> → Tabel referensi yang berisi daftar NIS dan nilai ujian.
              </li>
              <li>
                <span className="font-semibold">2</span> → Mengambil data dari kolom ke-<span className="font-semibold">2</span> dalam tabel referensi (kolom <span className="font-semibold">Nilai Ujian</span>).
              </li>
              <li>
                <span className="font-semibold">FALSE</span> → Hanya mencari NIS yang cocok persis.
              </li>
            </ul>
          </li>
          <li>
            <span className="font-semibold">Tekan Enter</span>
            <br />
            Nilai ujian untuk NIS pada <span className="font-semibold">C3</span> akan muncul di <span className="font-semibold">D3</span>.
          </li>
          <li>
            <span className="font-semibold">Terapkan rumus ke seluruh tabel</span>
            <ul className="list-disc pl-6 ml-6 space-y-1 mt-2">
              ...
              <li>
                Semua nilai ujian akan otomatis terisi sesuai dengan NIS masing-masing siswa.
              </li>
            </ul>
          </li>
        </ul>
