  ...
  return (
    <Layout>
      ...
      <p className="text-gray-700 text-sm md:text-base text-justify leading-relaxed px-4 mb-6">
        <strong>Petunjuk:</strong> Baca studi kasus dan tabel data di bawah ini, kemudian
        isilah rumus yang tepat untuk setiap pertanyaan berdasarkan fungsi
        spreadsheet yang sesuai. Klik tombol <em>“Periksa”</em> untuk mengetahui apakah
        jawabanmu sudah tepat. Jangan khawatir, kamu bisa mencoba lagi jika belum
        benar!
      </p>
      ...
      <section className="p-6 bg-white rounded shadow-lg">
        ...
        <p className="text-gray-700 text-sm md:text-base mt-2 text-justify leading-relaxed px-4">
          Kamu adalah anggota OSIS yang sedang merekap kegiatan partisipasi siswa
          dalam berbagai kegiatan sekolah. Data ini akan digunakan untuk menentukan
          siapa saja yang paling aktif dan kegiatan apa yang paling diminati. Kamu akan menggunakan
          rumus fungsi <strong>SUMIF, SUMIFS, COUNTIF,</strong> dan <strong>COUNTIFS</strong> untuk
      ...
      <section className="p-6 bg-white rounded shadow-lg mt-6">
        ...
        <p className="text-gray-600 text-sm mt-3 italic">
          Silakan kerjakan terlebih dahulu pada spreadsheet di atas. Gunakan fungsi SUMIF untuk mencari jumlah poin yang diperoleh oleh Naya. Setelah menemukan jawabannya, salin rumus lengkapnya (misalnya: <code>=SUMIF(...)</code>) ke dalam kolom di bawah.
        </p>
      ...
      {/* Soal 2 */}
      <section className="p-6 bg-white rounded shadow-lg mt-6">
        <h3 className="text-md font-semibold text-green-700">2. Pengenalan Pola</h3>
        <p className="text-gray-700 mt-3 leading-relaxed">
          <strong>Pertanyaan:</strong> Berapa total poin kelas 8A pada kegiatan Kebersihan?
        </p>
        <p className="text-gray-600 text-sm mt-3 italic">
          Silakan kerjakan terlebih dahulu pada spreadsheet di atas. Gunakan fungsi SUMIFS dengan dua kriteria: kelas 8A dan kegiatan Kebersihan. Setelah mendapatkan jawabannya, salin rumus lengkapnya ke kolom berikut.
        </p>
        <ul className="list-disc ml-6 text-gray-700 mt-2 text-sm md:text-base">
      ...
      <section className="p-6 bg-white rounded shadow-lg mt-6">
        ...
        <p className="text-gray-700 mt-3 leading-relaxed">
          <strong>Pertanyaan:</strong> Berapa jumlah siswa yang ikut kegiatan Olahraga?
        </p>
        <p className="text-gray-600 text-sm mt-3 italic">
          Silakan kerjakan terlebih dahulu pada spreadsheet di atas. Fokuslah hanya pada kolom kegiatan. Gunakan fungsi COUNTIF untuk menghitung berapa banyak siswa yang ikut kegiatan Olahraga.
        </p>
        <ul className="list-disc ml-6 text-gray-700 mt-2 text-sm md:text-base">
      ...
      <section className="p-6 bg-white rounded shadow-lg mt-6">
        ...
        <p className="text-gray-700 mt-3 leading-relaxed">
          <strong>Pertanyaan:</strong> Berapa jumlah siswa kelas 8A yang ikut kegiatan Kebersihan?
        </p>
        <p className="text-gray-600 text-sm mt-3 italic">
          Silakan kerjakan terlebih dahulu pada spreadsheet. Gunakan fungsi COUNTIFS dengan dua kriteria: siswa kelas 8A dan kegiatan Kebersihan. Setelah berhasil, salin rumus lengkapnya ke kolom berikut.
        </p>
        <ul className="list-disc ml-6 text-gray-700 mt-2 text-sm md:text-base">
      ...
      <div className="flex justify-between mt-10 px-4">
        ...
        <a
          ...
          className={`px-5 py-2 rounded-lg text-white ${
            allCorrect ? "bg-[#255F38] hover:bg-[#1E4D2E]" : "bg-gray-400 cursor-not-allowed"
          }`}
          onClick={(e) => {
