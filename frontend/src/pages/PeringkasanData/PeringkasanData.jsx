...
export default function PeringkasanData() {
  ...
  const calculate = () => {
    // Hitung SUMIF (total nilai berdasarkan kelas)
    let sumifRes = "-";
    if (sumifCriteria) {
      sumifRes = data
    ...
    // Hitung COUNTIF (jumlah siswa berdasarkan kondisi nilai)
    let countifRes = "-";
    if (countifCriteria) {
  ...
  return (
    <Layout>
      ...
      <div className="bg-white p-5 border-gray-300 space-y-4 mt-10 relative">
        ...
        {/* Kalkulator SUMIF dan COUNTIF dengan Tabel Data Baru */}
        <div className="bg-green-50 p-6 rounded-lg shadow-md mt-6">
          ...
          {/* Tabel Data Baru untuk Kalkulator */}
