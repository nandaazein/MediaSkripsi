...
const QuizPeringkasanData = () => {
  ...
  const answerOptions = {
    q1: {
      a: "=SUMIF(B2:B6, \">75\", C2:C6)",
      b: "=SUMIFS(B2:B6, \">75\")",
      c: "=COUNTIF(B2:B6, \">75\")",
      d: "=COUNTIFS(B2:B6, \">75\", C2:C6, \"Lulus\")",
    },
    q2: {
      a: "=SUMIF(C2:C5, \"Makanan\", D2:D5)",
      b: "=COUNTIF(C2:C5, \"Makanan\")",
      c: "=SUMIFS(C2:C5, \"Makanan\", D2:D5)",
      d: "=COUNTIFS(C2:C5, \"Makanan\", D2:D5, \">0\")",
    },
    q3: {
      a: "=SUMIF(C2:C6, \"8A\", D2:D6)",
      b: "=COUNTIF(C2:C6, \"8A\")",
      c: "=SUMIFS(D2:D6, C2:C6, \"8A\", D2:D6, \">75\")",
