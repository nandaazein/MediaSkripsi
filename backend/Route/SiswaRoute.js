...
// SiswaRoute.js
router.post('/scores/:nis', verifyToken, studentController.submitScore); // Hapus restrictTo('teacher')
router.get('/scores/:nis', verifyToken, studentController.getScores);
router.get('/scores/:nis', verifyToken, restrictTo('student'), studentController.getScores);
